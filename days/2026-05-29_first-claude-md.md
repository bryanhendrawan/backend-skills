...
**Theme**: Sekali tulis CLAUDE.md, AI ngerti repo kamu di setiap session.

## The Problem
<!-- Slide 2 -->

Tiap session AI mulai dari nol. Kamu ngulang konteks yang sama, tiap hari, ke chat yang baru.

## How It Works

1. Tulis Project Purpose: 2 kalimat, kenapa repo ini ada dan untuk siapa.
<!-- Slide 3 -->

2. List Commands yang sering dijalanin: go run ., go test, docker-compose up.
<!-- Slide 4 -->

3. Tulis Conventions: error handling, naming pattern, struktur folder yang kamu pakai.
<!-- Slide 5 -->

## Key Takeaway
<!-- Slide 6 -->

**CLAUDE.md bukan dokumentasi. Itu briefing untuk AI partner kamu.**

## Try It Today
<!-- Slide 7 -->

Buka repo aktif kamu sekarang. Tulis CLAUDE.md, 10 menit, 3 section.
...
- Subheading: Sekali tulis CLAUDE.md, AI ngerti repo kamu di setiap session. — 18–22px soft lavender
...
- Headline: Tiap session AI mulai dari nol. — H2, 44–52px bold white, left-aligned
- Body: Kamu ngulang konteks yang sama, tiap hari, ke chat yang baru. — 24–28px white
...
- Body: Tulis Project Purpose: 2 kalimat, kenapa repo ini ada dan untuk siapa. — 24–28px white, left-aligned to the right of the badge
...
- Body: List Commands yang sering dijalanin: go run ., go test, docker-compose up. — 24–28px white, left-aligned to the right of the badge
...
- Body: Tulis Conventions: error handling, naming pattern, struktur folder yang kamu pakai. — 24–28px white, left-aligned to the right of the badge
...
- Statement: CLAUDE.md bukan dokumentasi. Itu briefing untuk AI partner kamu. — H2, 44–52px bold white, left-aligned
...
- Action: Buka repo aktif kamu sekarang. Tulis CLAUDE.md, 10 menit, 3 section. — H2, 44–52px bold white, left-aligned
